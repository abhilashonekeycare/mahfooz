...
public function get_test_messages()
{
$query = $this->db->get('test_messages');
return $query->result();
}
...
public function field_login($username, $password) 
{
$this->db->where('username', $username);
$this->db->where('password', md5($password));
$query = $this->db->get('users');
...
$query = $this->db->query("SELECT `OPV_O`,`OPV_O_date`,`OPV_O_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."' AND `OPV_O`='false'");
...
// $query = $this->db->query("SELECT `OPV_O`,`OPV_O_date`,`OPV_O_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details`  WHERE '".$today."' >= `OPV_O_date` AND '".$today."' <= `OPV_O_last_date` AND `child_id` = '".$child_id."' AND `OPV_O`='false'");
...
public function get_allocd_child_id($child_id)
{

$query = $this->db->query("SELECT call_for,call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'no' AND call_status = 'complete' ");
// $query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'no' AND `created_date` = '".date('Y-m-d')."' ORDER BY created_at DESC LIMIT 1 ");
...
//$query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'no' AND `created_date` = '".date('Y-m-d')."' ");
 $query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'no' AND `created_date` = '".date('Y-m-d')."' ORDER BY created_at DESC LIMIT 1 ");
...
public function get_follow_up_child($child_id)
{
	 $today_date = date('Y-m-d');

   $yesterday = date('Y-m-d', strtotime($today_date. ' - 1 day'));

// $query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'yes' AND `created_date` = '".date('Y-m-d')."' OR `created_date` = '".$yesterday."'");

   $query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'yes' AND `created_date` = '".date('Y-m-d')."'");
...
$query = $this->db->query("SELECT `OPV_O`,`RVV1`,`RVV1_date`,`RVV1_last_date`,`IPV1`,`IPV1_date`,`IPV1_last_date`,`OPV1`,`OPV1_date`,`OPV1_last_date`,`DPT1`,`DPT1_date`,`DPT1_last_date`,`PENTA1`,`PENTA1_date`,`PENTA1_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'   ");
...
$query = $this->db->query("SELECT `RVV1`,`RVV1_date`,`RVV1_last_date`,`IPV1`,`IPV1_date`,`IPV1_last_date`,`OPV1`,`OPV1_date`,`OPV1_last_date`,`DPT1`,`DPT1_date`,`DPT1_last_date`,`PENTA1`,`PENTA1_date`,`PENTA1_last_date`,`RVV2`,`RVV2_date`,`RVV2_last_date`,`OPV2`,`OPV2_date`,`OPV2_last_date`,`DPT2`,`DPT2_date`,`DPT2_last_date`,`PENTA2`,`PENTA2_date`,`PENTA2_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
$query = $this->db->query("SELECT `RVV2`,`RVV2_date`,`RVV2_last_date`,`OPV2`,`OPV2_date`,`OPV2_last_date`,`DPT2`,`DPT2_date`,`DPT2_last_date`,`PENTA2`,`PENTA2_date`,`PENTA2_last_date`,`RVV3`,`RVV3_date`,`RVV3_last_date`,`IPV2`,`IPV2_date`,`IPV2_last_date`,`OPV3`,`OPV3_date`,`OPV3_last_date`,`DPT3`,`DPT3_date`,`DPT3_last_date`,`PENTA3`,`PENTA3_date`,`PENTA3_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
$wed = date('Y-m-d', strtotime('next Wednesday'));
$last_wed = date('Y-m-d', strtotime('last Wednesday'));
$query = $this->db->query("SELECT `JE1`,`JE1_date`,`JE1_last_date`,`OPV3`,`OPV3_date`,`OPV3_last_date`,`DPT3`,`DPT3_date`,`DPT3_last_date`,`MMR`,`MMR_date`,`MMR_last_date`,`DPT_1_BOOSTER`,`DPT_1_BOOSTER_date`,`DPT_1_BOOSTER_last_date`,`MMR2`,`MMR2_date`,`MMR2_last_date`,`OPV_BOOSTER`,`OPV_BOOSTER_date`,`OPV_BOOSTER_last_date`,`JE2`,`JE2_date`,`JE2_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
return $query->result();
...
$wed = date('Y-m-d', strtotime('next Wednesday'));
$last_wed = date('Y-m-d', strtotime('last Wednesday'));
$query = $this->db->query("SELECT `DPT_1_BOOSTER`,`DPT_1_BOOSTER_date`,`DPT_1_BOOSTER_last_date`,`DPT_2_BOOSTER`,`DPT_2_BOOSTER_date`,`DPT_2_BOOSTER_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
return $query->result();

}


// =====================GET FOLLOW UP CALLS FOR VACCINATION =========================================================

public function get_follow_bucket2_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
...
$query = $this->db->query("SELECT `OPV_O`,`OPV_O_date`,`OPV_O_last_date`,`OPV_O_done_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
public function get_follow_bucket3_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
...
$query = $this->db->query("SELECT `RVV1`,`RVV1_date`,`RVV1_last_date`,`RVV1_done_date`,`IPV1`,`IPV1_done_date`,`IPV1_date`,`IPV1_last_date`,`OPV1`,`OPV1_done_date`,`OPV1_date`,`OPV1_last_date`,`DPT1`,`DPT1_done_date`,`DPT1_date`,`DPT1_last_date`,`PENTA1`,`PENTA1_done_date`,`PENTA1_date`,`PENTA1_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'   ");
...
public function get_follow_bucket4_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
...
$query = $this->db->query("SELECT `RVV2`,`RVV2_done_date`,`RVV2_date`,`RVV2_last_date`,`OPV2`,`OPV2_done_date`,`OPV2_date`,`OPV2_last_date`,`DPT2`,`DPT2_done_date`,`DPT2_date`,`DPT2_last_date`,`PENTA2`,`PENTA2_done_date`,`PENTA2_date`,`PENTA2_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
public function get_follow_bucket5_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
...
$query = $this->db->query("SELECT `RVV3`,`RVV3_done_date`,`RVV3_date`,`RVV3_last_date`,`IPV2`,`IPV2_done_date`,`IPV2_date`,`IPV2_last_date`,`OPV3`,`OPV3_done_date`,`OPV3_date`,`OPV3_last_date`,`DPT3`,`DPT3_done_date`,`DPT3_date`,`DPT3_last_date`,`PENTA3`,`PENTA3_done_date`,`PENTA3_date`,`PENTA3_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
public function get_follow_bucket6_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
...
$query = $this->db->query("SELECT `MMR`,`MMR_done_date`,`MMR_date`,`MMR_last_date`,`VIT_A_1`,`VIT_A_1_done_date`,`VIT_A_1_date`,`VIT_A_1_last_date`,`JE1`,`JE1_done_date`,`JE1_date`,`JE1_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
...
//==================BUCKET 7 ===========================
public function get_follow_bucket7_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
$last_wed = date('Y-m-d', strtotime('last Wednesday'));
$query = $this->db->query("SELECT `DPT_1_BOOSTER`,`DPT_1_BOOSTER_done_date`,`DPT_1_BOOSTER_date`,`DPT_1_BOOSTER_last_date`,`MMR2`,`MMR2_done_date`,`MMR2_date`,`MMR2_last_date`,`OPV_BOOSTER`,`OPV_BOOSTER_done_date`,`OPV_BOOSTER_date`,`OPV_BOOSTER_last_date`,`JE2`,`JE2_done_date`,`JE2_date`,`JE2_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
return $query->result();
...
public function get_follow_bucket8_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
$last_wed = date('Y-m-d', strtotime('last Wednesday'));
$query = $this->db->query("SELECT `VIT_A_2`,`VIT_A_2_done_date`,`VIT_A_2_date`,`VIT_A_2_last_date`,`VIT_A_3`,`VIT_A_3_done_date`,`VIT_A_3_date`,`VIT_A_3_last_date`,`VIT_A_4`,`VIT_A_4_done_date`,`VIT_A_4_date`,`VIT_A_4_last_date`,`VIT_A_5`,`VIT_A_5_done_date`,`VIT_A_5_date`,`VIT_A_5_last_date`,`VIT_A_6`,`VIT_A_6_done_date`,`VIT_A_6_date`,`VIT_A_6_last_date`,`VIT_A_7`,`VIT_A_7_done_date`,`VIT_A_7_date`,`VIT_A_7_last_date`,`VIT_A_8`,`VIT_A_8_done_date`,`VIT_A_8_date`,`VIT_A_8_last_date`,`VIT_A_9`,`VIT_A_9_done_date`,`VIT_A_9_date`,`VIT_A_9_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
return $query->result();
...
public function get_follow_bucket9_dates_id($child_id)
{
$today = date('Y-m-d');
$wed = date('Y-m-d', strtotime('next Wednesday'));
$last_wed = date('Y-m-d', strtotime('last Wednesday'));
$query = $this->db->query("SELECT `DPT_2_BOOSTER`,`DPT_2_BOOSTER_done_date`,`DPT_2_BOOSTER_date`,`DPT_2_BOOSTER_last_date`,`mother_name`, `child_name`, `child_contact`, `child_unq_id` FROM `children_details` WHERE  `child_id` = '".$child_id."'");
return $query->result();
...
// ======================= END OF GET FOLLOW UP CALLS FOR VACCINATION  ==============================================
...
public function insertTSTdata($tstData)
{
$this->db->insert('test_messages', $tstData);
return $this->db->insert_id();
}

public function updateTestmessages($id, $tstmsgData)
{
$this->db->where('test_id', $id);
$this->db->update('test_messages', $tstmsgData);
}
