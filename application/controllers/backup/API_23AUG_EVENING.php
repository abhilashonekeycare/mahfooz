...
}elseif ($dinnank == "Tue") {	 //8 to 10
$bcg_dates_posts[] = array(
'vaccine' => 'BCG',
'child_id' => $bcg_date->child_unq_id,
'mobile' => $bcg_date->child_contact,
'message' => $bcg_date->child_name.' का Tuesday BCG टीका का टीकाकरण दिनांक '.$wed.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',
...
// $total_array = array_merge($bcg_dates_posts,$opv_dates_posts,$opv1_dates_posts,$opv2_dates_posts,$opv3_dates_posts,$dpt1_dates_posts,$dpt2_dates_posts,$dpt3_dates_posts,$hepb1_dates_posts,$hepb2_dates_posts,$hepb3_dates_posts,$rvv1_dates_posts,$rvv2_dates_posts,$rvv3_dates_posts,$ipv1_dates_posts,$ipv2_dates_posts,$penta1_dates_posts,$penta2_dates_posts,$penta3_dates_posts,$mmr_dates_posts,$mmr2_dates_posts,$je1_dates_posts,$je2_dates_posts,$vit_a_1_dates_posts,$vit_a_2_dates_posts,$vit_a_3_dates_posts,$vit_a_4_dates_posts,$vit_a_5_dates_posts,$vit_a_6_dates_posts,$vit_a_7_dates_posts,$vit_a_8_dates_posts,$vit_a_9_dates_posts,$opv_booster_dates_posts,$je1_dates_posts,$je2_dates_posts,$dpt1_booster_dates_posts,$dpt2_booster_dates_posts);
  ...
  $opv_booster_dates_posts = array();$je1_dates_posts = array();$je2_dates_posts = array();
...
if ($dinnank == "Sun") {	 //Sunaday OutBound Calls 
$bcg_dates_posts[] = array(
'vaccine' => 'BCG',
'child_id' => $bcg_date->child_unq_id,
'mobile' => $bcg_date->child_contact,
...
// 	if ($rvv1_date->RVV1 == 'false' && $rvv1_date->IPV1 == 'false' && $rvv1_date->OPV1 == 'false' && $rvv1_date->DPT1 == 'false' && $rvv1_date->HepB1 == 'false' && $rvv1_date->PENTA1 == 'false'  ) {
// 		echo "falseall";
// 	}elseif($rvv1_date->RVV1 == 'false' && $rvv1_date->IPV1 == 'false' || $rvv1_date->OPV1 == 'false' || $rvv1_date->DPT1 == 'false' || $rvv1_date->HepB1 == 'false' || $rvv1_date->PENTA1 == 'false' || $rvv1_date->IPV1 == 'true' || $rvv1_date->OPV1 == 'true' || $rvv1_date->DPT1 == 'true' || $rvv1_date->HepB1 == 'true' || $rvv1_date->PENTA1 == 'true'){
// echo "RVV1 False h sirf";
// 	}

if ($dinnank == "Sun") {	 //Sunday OutBound Calls  For Wednesday
...
// // 'child_id' => $rvv1_date->child_unq_id,
// // 'mobile' => $rvv1_date->child_contact,
// // 'message' => $rvv1_date->child_name.' का Sunday Call for RVV1 टीका का टीकाकरण दिनांक '.$sat.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',

// );


// }else
// if($rvv1_date->RVV1 == 'false' && $rvv1_date->IPV1 == 'false' || $rvv1_date->OPV1 == 'false' || $rvv1_date->DPT1 == 'false' || $rvv1_date->HepB1 == 'false' || $rvv1_date->PENTA1 == 'false' || $rvv1_date->IPV1 == 'true' || $rvv1_date->OPV1 == 'true' || $rvv1_date->DPT1 == 'true' || $rvv1_date->HepB1 == 'true' || $rvv1_date->PENTA1 == 'true'){

	if($rvv1_date->RVV1 == 'false' && $rvv1_date->IPV1 == 'true' && $rvv1_date->OPV1 == 'true' && $rvv1_date->DPT1 == 'true' && $rvv1_date->HepB1 == 'true' && $rvv1_date->PENTA1 == 'true'){

$rvv1_dates_posts[] = array(
'vaccine' => 'RVV1',
'child_id' => $rvv1_date->child_unq_id,
'mobile' => $rvv1_date->child_contact,
'message' => "Sunady RVV 1 Nhi lga hai",
...
'child_id' => $rvv1_date->child_unq_id,
'mobile' => $rvv1_date->child_contact,
'message' => "Tuesday RVV 1 Nhi lga hai",
...
'child_id' => $rvv1_date->child_unq_id,
'mobile' => $rvv1_date->child_contact,
'message' => "Wednesday RVV 1 Nhi lga hai",
...
'child_id' => $rvv1_date->child_unq_id,
'mobile' => $rvv1_date->child_contact,
'message' => "Friday RVV 1 Nhi lga hai",
