...
$test_messages = array();
if(!empty($test_messages)){
foreach($test_messages as $test_messages){
$test_messages[] = array(
'id' => $test_messages->test_id,
'mobile' => $test_messages->mobile_no,
'messages' => $test_messages->message,
'status' => $test_messages->status,
'read_time' => $test_messages->read_time
