...
}elseif ($dinnank == "Wed" && $samay >= "16" && $samay < "20") {	
$bcg_dates_posts[] = array(
'vaccine' => 'BCG',
// 'due_date' => $bcg_date->BCG_date,
'child_id' => $bcg_date->child_unq_id,
...
}elseif ($dinnank == "Sat" && $samay < "12") {	
$bcg_dates_posts[] = array(
'vaccine' => 'BCG',
// 'due_date' => $bcg_date->BCG_date,
'child_id' => $bcg_date->child_unq_id,
'mobile' => $bcg_date->child_contact,
'message' => $bcg_date->child_name.' का Saturday morning BCG टीका का टीकाकरण दिनांक '.$wed.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',
// 'message' => $bcg_date->child_name.' का BCG टीका का टीकाकरण दिनांक '.$bcg_date->BCG_date.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',
);

}elseif ($dinnank == "Sat" && $samay >= "16" && $samay < "20") {	
$bcg_dates_posts[] = array(
'vaccine' => 'BCG',
// 'due_date' => $bcg_date->BCG_date,
'child_id' => $bcg_date->child_unq_id,
'mobile' => $bcg_date->child_contact,
'message' => $bcg_date->child_name.' का Saturday Evening Follow Up Calls - BCG टीका का टीकाकरण दिनांक '.$wed.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',
// 'message' => $bcg_date->child_name.' का BCG टीका का टीकाकरण दिनांक '.$bcg_date->BCG_date.' को है कृपया अपने नजदीकी स्वस्थ्य केंद्र में जाकर बच्चे का टीकाकरण करवाए|',
);
