...
if($countbck3['false']=='2' || $countbck3['false']=='1')
{
...
// 	$check_call = array();
//  $call_for = array();
// foreach ($get_allocd_child_id as $get_allocd_child_id) { $check_array[]= $get_allocd_child_id->call_status; }
...
$VIT_A_4_date = date('Y-m-d', strtotime($cdob. ' + 540 days'));
...
$VIT_A_5_date = date('Y-m-d', strtotime($cdob. ' + 540 days'));
