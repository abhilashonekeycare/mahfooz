...
// $query = $this->db->query("SELECT call_status FROM `outbound_calls_data` WHERE  `ocd_child_id` = '".$child_id."' AND `follow_up_data` = 'yes' AND `created_date` = '".date('Y-m-d')."' OR `created_date` = '".$yesterday."' ORDER BY created_at DESC LIMIT 1");
