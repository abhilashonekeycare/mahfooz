...
if ($dinnank == "Sun" || $dinnank == "Mon" || $dinnank == "Tue"|| $dinnank == "Wed" && $samay == "15" || $dinnank == "Thu"|| $dinnank == "Fri") {
...
"Message" => 'नमस्ते '.$mothername.'जी आपके बच्चे '.$childname.' को '.$msg
...
if($dinnank == "Sun" || $dinnank == "Mon" || $dinnank == "Thu"){
	...
	$msg = 'कल हैजा, पोलीयो, दिमाग़ का बुखार, काली खाँसी और गालघोंटू जैसी गंभीर बीमारियों से बचाने का टीका लगना है, कृपया आशा दीदी से संपर्क करें और यह टीका लगवाना ना भूलें ';
...
if ($dinnank == "Sun" || $dinnank == "Mon" || $dinnank == "Tue"|| $dinnank == "Wed" && $samay == "15" || $dinnank == "Fri" || $dinnank == "Thu") {
...
if($dinnank == "Sun" || $dinnank == "Mon" || $dinnank == "Thu"){
	...
	$msg = 'खसरे का टीका और विटामिन ए की खुराक देने का समय आ गया है , कृपया अपनी आशा बहें से संपर्क करें और  आने वाली तारीख '.$wed.' को टीकाकरण मे बच्चे को ले जाना ना भूलें ';
...
if($dinnank == "Sun" || $dinnank == "Mon" || $dinnank == "Thu"){
	...
	$msg = 'काली खाँसी, टिटनेस और खसरे का टीका देने का समय आ गया है , कृपया अपनी आशा बहें से संपर्क करें और आने वाली तारीख '.$wed.' को टीकाकरण मे बच्चे को ले जाना ना भूलें';
...
"follow_up" => "no",
"mobile_no" => $child_contact_no,
"Message" => 'नमस्ते '.$mothername.' जी आपके बच्चे '.$childname.' का '.$msg 
...
if($RVV1_sts!=="false" && $DPT1_sts!=="false" && $OPV1_sts!=="false" && $PENTA1_sts!=="false" ){
...
$ocd_child_id3 = $this->api_model->get_ocd_child_id($child_id);
if($RVV2_sts!=="false" && $DPT2_sts!=="false" && $IPV1_sts!=="false" && $OPV2_sts!=="false" && $PENTA2_sts!=="false" ){
	$BUCKET5_MESSAGES[] = array(
"child_id" => $child_id,
"OutCallDetails" => $ocd_child_id3,
"message_for" => "BUCKET5",
...
$DPT_1_BOOSTER_sts = $bucket9_data->DPT_2_BOOSTER;
$DPT_2_BOOSTER = $bucket9_data->DPT_2_BOOSTER;
$DPT_2_BOOSTER_date = $bucket9_data->DPT_2_BOOSTER_date;
$DPT_2_BOOSTER_last_date = $bucket9_data->DPT_2_BOOSTER_last_date;
...
if ($dinnank == "Tue" || $dinnank == "Wed" && $samay == "16" || $dinnank == "Wed" && $samay == "17" || $dinnank == "Wed" && $samay == "18"|| $dinnank == "Wed" && $samay == "19" || $dinnank == "Sat" && $samay == "16" || $dinnank == "Sat" && $samay == "17" || $dinnank == "Sat" && $samay == "18" || $dinnank == "Sat" && $samay == "19") {
foreach ($child_details as $child_details) {
...
"follow_up" => "yes",
"mobile_no" => $child_contact_no,
"Message" => 'नमस्ते '.$mothername.'जी आपके बच्चे '.$childname.'का टीकाकरण कराने के लिए धन्यवाद, कृपया ए एन एम दीदी द्वारा दी गयी सलाह का पालन करें और अपने बच्चे के स्वस्थ को सुरक्षित करें |'

//नमस्ते सुरुचि जी आपके बच्चे शिला का टीकाकरण कराने के लिए धन्यवाद| कृपया ए एन एम दीदी द्वारा दी गयी सलाह का पालन करें और अपने बच्चे के स्वस्थ को सुरक्षित करें |
