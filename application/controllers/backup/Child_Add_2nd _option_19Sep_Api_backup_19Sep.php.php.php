...
// Date OF Birth From Excel
$excldob1 = $this->db->escape_str($data[4]);
$dateOFBirth1 = str_replace('/', '-', $excldob1);
$cdob1 =  date('Y-m-d', strtotime($dateOFBirth1));

$datam['child_dob'] = $cdob1; 

// Date Of Birth From Excel Sheet
