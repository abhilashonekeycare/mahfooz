...
//echo(rand(7,77777));
    ...
    $datam['child_dob'] = $this->db->escape_str($data[4]);
    $datam['child_status'] = "0";

    $datam['is_vacinated_before'] = $this->db->escape_str($data[4]);
    $datam['BCG'] = $this->db->escape_str($data[4]);
    $datam['BCG_date'] = $this->db->escape_str($data[4]);
    $datam['BCG_last_date'] = $this->db->escape_str($data[4]);
    $datam['BCG_done_date'] = $this->db->escape_str($data[4]);
